...
const AllProducts = ({ productData, index }) => {
  return (
    <Link
      ...
      className="bg-slate-300 mx-4 my-2 rounded-md hover:shadow-[1px_1px_10px_rgb(256,256,256)] hover:-translate-y-1 transition ease-in-out duration-200 max-sm:mx-1"
    >
